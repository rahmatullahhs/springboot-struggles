...
import { faPlusCircle, faTag, faImage, faDollarSign, faBoxes, faUser, faBox, faTags, faPlus, faCalendarAlt, faUserTie }
  ...
  onSubmit() {
    if (this.image) {
      ...
      const product: ProductModule = {
        ...
        supplier: { id: this.formValue.value.supplier } as SupplierModule,
        branch: { id: this.formValue.value.branch } as BranchModule,
