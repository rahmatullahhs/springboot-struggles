...
import com.emranhss.merchandise.service.RoleCashierService;
...
public class RoleCashierController {
    ...
    public ResponseEntity<Map<String, String>> saveCashier(
        ...
        try {
            ...
            RoleCashier roleCashier = objectMapper.readValue(cashierJson, RoleCashier.class);
    ...
    public ResponseEntity<?> getProfile(Authentication authentication) {
        ...
        RoleCashier roleCashier = roleCashierService.getProfileByUserId(user.get().getId());
        return ResponseEntity.ok(roleCashier);
