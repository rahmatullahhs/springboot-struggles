...
@Component({
  selector: 'app-gulshanbranchstock',
  templateUrl: './gulshanbranchstock.component.html',
  styleUrl: './gulshanbranchstock.component.css'
})
export class GulshanbranchstockComponent {
