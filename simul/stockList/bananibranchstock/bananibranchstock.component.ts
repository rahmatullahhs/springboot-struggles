...
@Component({
  selector: 'app-bananibranchstock',
  templateUrl: './bananibranchstock.component.html',
  styleUrl: './bananibranchstock.component.css'
})
export class BananibranchstockComponent {
